...
FORCEEND:
        ...
        str.Append("     File Length: " & RSet(fileData.Length.ToString("#,#"), 15) & vbCrLf)
        str.Append("     Total Lines: " & RSet(totalLines.ToString("#,#"), 15) & vbCrLf) ' totalLines
        ...
        If f = DialogResult.OK Then
            ...
            If Path.GetExtension(OpenFileDialog1.FileName) = ".fsm" Then
                ...
                If Path.GetExtension(OpenFileDialog1.FileName.Remove( _
                    ...
                    Exit Sub
                End If
            ElseIf Path.GetExtension(OpenFileDialog1.FileName) = ".sdb" Then
                sdb_opened = True
                sdb_global_filename = OpenFileDialog1.FileName
                frmStatistics.Show()
                Exit Sub
            Else
    ...
    Private Sub ListView1_KeyDown(sender As Object, e As KeyEventArgs) Handles ListView1.KeyDown
        ...
        ElseIf e.KeyCode = Keys.F4 Then
            If ready Then
                MsgBox("다른 작업을 마친 후 다시시도하십시오.", MsgBoxStyle.Critical, "RollRat Grep")
                Exit Sub
            End If
            frmFolder.Show()
        ...
        ElseIf e.KeyCode = Keys.F8 Then
            ...
            MsgBox("확장자로 DB추출이 " & extensionGroupCheck.ToString & "로 변경되었습니다.", MsgBoxStyle.Information, "RollRat Grep")
        ElseIf e.KeyCode = Keys.F9 Then
            ...
            End If
            notallowsyntax = Not notallowsyntax
            MsgBox("NotAllowSyntax이 " & notallowsyntax.ToString & "로 변경되었습니다.", MsgBoxStyle.Information, "RollRat Grep")
        ElseIf e.KeyCode = Keys.F11 Then
            Dim x = MsgBox("", MsgBoxStyle.Exclamation Or MsgBoxStyle.AbortRetryIgnore, "RollRat Grep")
        ...
        ElseIf e.KeyCode = Keys.F12 Then
            ...
            If LoadFiles.Count = 0 Then
                ignore_open = True
                frmStatistics.Show()
                'MsgBox("데이터가 먼저 로드되어야 합니다.", MsgBoxStyle.Critical, "RollRat Grep")
            Else
                'frmStatisticsOld.Show()
                frmStatistics.Show()
            End If
        End If
    End Sub

...
Public Class frmSecurity
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If f = Windows.Forms.DialogResult.OK Then
            ...
            If Path.GetExtension(OpenFileDialog1.FileName.Remove( _
                ...
                If pass = "" Then
                    MsgBox("취소 되었습니다.", MsgBoxStyle.Exclamation)
                    Exit Sub
                End If
    ...
    Private Sub AES_EncryptFromToFile(ByVal [from] As String, ByVal [to] As String, _
        ...
        Dim ptrbuffer As UInt64 = 0
        Dim procbuffer As UInt64 = 0
    ...
    Private Sub _KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles MyBase.KeyDown
        ...
        '
        '   파일을 Vb.Net Byte()형식의 Hex로 출력합니다.
        '
        If e.KeyCode = Keys.F2 Then
            ...
            If f = Windows.Forms.DialogResult.OK Then
                ...
                '   대표파일에 저장
                '
                File.WriteAllText(OpenFileDialog1.FileName & ".dxcode", dxSecretService.MultiFile2VbNetHexWithModule(OpenFileDialog1.FileNames))
